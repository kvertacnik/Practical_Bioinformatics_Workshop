...
For each sample, we are creating and submitting new sample-specific job scripts by combining the header from 6_gatk_hapcaller_header with the gatk HaplotypeCaller command. 
